...
skel_matrix = function(tree){
  ...
  m = matrix(0, nrow = 2^max_char, ncol = 2^max_char, dimnames = list(pasts, pasts)) #this combination of sorted and unsorted pasts creates "blocks" in the transitions that could have positive probabilities
  for(p in pasts){
